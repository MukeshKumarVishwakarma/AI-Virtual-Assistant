...
const geminiResponse=async (command,assistantName,userName) => {
    try {
        ...
        "userInput": "<original user input>" {only remove your name from userimput if exists} and
        agar kisi ne google ya youtube pe kuch search karne ko bole hai to userInput me only bo search baala text jaye,
