...
function Customize2() {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] relative'>
      ...
      <input type="text" placeholder='eg. shifra' className='w-full h-[60px] 
      outline-none border-2 border-white bg-transparent text-white max-w-[600px]
      ...
      font-semibold bg-white cursor-pointer rounded-full text-[19px]' 
      disabled={laoding}
      onClick={()=>{
        handleUpdateAssistant()
      }
      } >{!laoding ? "Finally Create Your Assistant":"Loading..."}</button> }
